...
try:
    while True:
        ...
        prosseguir = input("Deseja atualizar o dado de alguma chave? (s/n): ")
        match prosseguir:
            case "s":
                chave_escolhida = input("Informe a chave que deseja alterar: ")

                if chave_escolhida in chaves:
                    usuario[chave_escolhida] = input("Inform o novo valor da chave escolhida: ")
                    os.system("cls")
                    continue
